...
@pytest.mark.parametrize("test_input, expected_input", testdata.get_hash)
...
@pytest.mark.parametrize("test_input, expected_input", testdata.gen_bit_number)
...
@pytest.mark.parametrize("test_input, expected_input", testdata.generator_exists)
...
@pytest.mark.parametrize("test_input, expected_input", testdata.sanitize_path)
...
def test_copy_to_temp_directory():
    ...
    assert (
        path_result == path_expected
    ), f"Returns {path_result} instead {path_expected}"
